...
const Projects = () => {
  return (
    <section id="projectsTag">
        <div className="row" style={{boxShadow: '0px 0px 20px var(--bs-black)', background: 'url("public/img/4k_mkbhd_icons_template_@jus_georgex.png") center / cover, #27262e', paddingBottom: '12px', margin: '0px'}}>
